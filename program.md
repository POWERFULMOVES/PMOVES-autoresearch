...
5. (Optional) Report to NATS: `python nats_reporter.py` — publishes results to `research.autoresearch.result.v1` on the PMOVES event bus. Skips gracefully if NATS is unavailable.
